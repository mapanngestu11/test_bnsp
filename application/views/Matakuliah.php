...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo base_url('Matakuliah/Add') ?>" method="post">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Kode Matakuliah </label>
                                                        <input type="text" name="kode_mk" class="form-control" placeholder="kode" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Matakuliah </label>
                                                        <input type="text" name="matakuliah" class="form-control" placeholder="matakuliah" required>
                                                    </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th> <button type="button" class="btn btn-warning" style="color: white;" data-toggle="modal" data-target="#exampleModal<?php echo $id ?>">
                                                        Edit
                                                    </button> | <a href="<?php echo base_url() . 'Matakuliah/Delete/' . $id; ?>" class="btn btn-danger">Hapus</button></th>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>
        ...
        <!-- modal edit -->
        <?php foreach ($matkul->result_array() as $row) :
            $id = $row['id'];
            $kode_mk = $row['kode_mk'];
            $matakuliah = $row['matakuliah'];
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url('Matakuliah/Update') ?>" method="post">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Kode Matakuliah </label>
                                    <input type="text" name="kode_mk" class="form-control" placeholder="nim" value="<?php echo $kode_mk ?>" required>
                                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                </div>
                                <div class="form-group">
                                    <label>Matakuliah </label>
                                    <input type="text" name="matakuliah" class="form-control" placeholder="nama" value="<?php echo $matakuliah ?>" required>
                                </div>
