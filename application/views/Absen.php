                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th> <button type="button" class="btn btn-warning" style="color: white;" data-toggle="modal" data-target="#exampleModal<?php echo $id ?>">
                                                        Edit
                                                    </button> | <a href="<?php echo base_url() . 'Absen/Delete/' . $id; ?>" class="btn btn-danger">Hapus</button></th>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>
        ...
        ?>
            <div class="modal fade" id="exampleModal<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update Data Absen</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="<?php echo base_url('Absen/Update') ?>" method="post">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Nim </label>
