                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Nilai Akhir</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <!-- end -->
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($nilai->result_array() as $row) :
                                            ...
                                            $persentase  = $jumlah_hadir / $jumlah_total * 0.1;
                                            $nilai_akhir = $total_nilai + $persentase;


                                            if ($nilai_akhir >= 80 && 100) {
                                                $grade = "A";
                                            } elseif ($nilai_akhir >= 70 && 79) {
                                                $grade = "B";
                                            } elseif ($nilai_akhir >= 60 && 69) {
                                                $grade = "C";
                                            } elseif ($nilai_akhir >= 50 && 59) {
                                                $grade = "D";
                                            } else {
                                                $grade = "E";
                                            }
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php echo $nim ?></th>
                                                <th><?php echo $nama ?></th>
                                                <th><?php echo round($nilai_akhir) ?></th>
