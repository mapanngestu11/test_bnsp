                      ...
                      <form action="<?php echo base_url('Mahasiswa/Add') ?>" method="post">
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name="no_hp" class="form-control" placeholder="08123XXX" required>
                          </div>
                        </div>
                    ...
                    ?>
                      <tr>
                        ...
                        <th> <button type="button" class="btn btn-warning" style="color: white;" data-toggle="modal" data-target="#exampleModal<?php echo $id ?>">
                            Edit
                          </button> | <a href="<?php echo base_url() . 'Mahasiswa/Delete/' . $id; ?>" class="btn btn-danger">Hapus</button></th>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                  <tfoot>
          ...
          <div class="modal-content">
            ...
            <form action="<?php echo base_url('Mahasiswa/Update') ?>" method="post">
              <div class="modal-body">
                <div class="form-group">
                  <label>Nim </label>
                  <input type="number" name="nim" class="form-control" placeholder="nim" value="<?php echo $nim ?>" required>
                ...
                <div class="form-group">
                  <label>Jurusan</label>
                  <input type="text" name="jurusan" class="form-control" placeholder="jurusan" value="<?php echo $jurusan ?>" required>
                </div>
                <div class="form-group">
                  <label>No Handphone</label>
                  <input type="number" name="no_hp" class="form-control" placeholder="08123XXX" value="<?php echo $no_hp ?>" required>
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
